 ...
 *
 * A real implementation over confirmed conversation nodes. The composer
 * frontend does not currently call it (session history navigation is
 * dormant). Kept functional, not a dead wrapper; re-wire together with
 * ../input-history.ts.
 */
import {
