...
export const sidebarApi = {
  ...
  gitPush: (scope: CapabilitiesScope): Promise<void> => callCapabilitiesApi('git.push', scope, { confirm: true }),
  gitForcePush: (scope: CapabilitiesScope): Promise<void> => callCapabilitiesApi('git.force-push', scope, { confirm: true }),
